...
public class PushNotificationPayload extends Payload {
  ...
  public PushNotificationPayload(String rawJSON) throws JSONException {
    super(rawJSON);
    JSONObject payload = getPayload();
    apsDictionary = payload.optJSONObject("aps");
  ...
  public void addBadge(int badge) throws JSONException {
    ...
    put("badge", badge, apsDictionary, true);
  }
  ...
  public void addSound(String sound) throws JSONException {
    ...
    put("sound", sound, apsDictionary, true);
  }
  ...
  public void addAlert(String alertMessage) throws JSONException {
    ...
    put("alert", alertMessage, apsDictionary, false);
  }
  ...
  public void addCategory(String category) throws JSONException {
    ...
    PushNotificationPayload.logger.debug("Adding category [" + category + "]" + (previousCategory != null ? " replacing previous category [" + previousCategory + "]" : ""));
    put("category", category, apsDictionary, false);
  }
  ...
  private JSONObject getOrAddCustomAlert() throws JSONException {
    ...
    if (alert == null) {
      ...
      put("alert", alert, apsDictionary, false);
    }
    return alert;
  }
  ...
  private <T> T getCompatibleProperty(String propertyName, Class<T> expectedClass, String exceptionMessage) throws JSONException {
    return getCompatibleProperty(propertyName, expectedClass, exceptionMessage, apsDictionary);
  }
  ...
  public int getMaximumPayloadSize() {
    return PushNotificationPayload.MAXIMUM_PAYLOAD_LENGTH;
  }
