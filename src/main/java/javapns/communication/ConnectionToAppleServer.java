...
public abstract class ConnectionToAppleServer {
  ...
  private void doTunnelHandshake(Socket tunnel, String host, int port) throws IOException {
    ...
    /*
     * Converting the byte array to a string is slightly wasteful in the case where the connection was successful, but it's insignificant compared to the network overhead.
     */
    String replyStr;
    try {
